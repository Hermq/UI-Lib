	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.Name = "Button"
				Button:SetAttribute("ItemLabel", text)
				...
				return {Remove = function() Button:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			function ChannelContent:Toggle(text,default,callback)
				...
				Toggle.Name = "Toggle"
				Toggle:SetAttribute("ItemLabel", text)
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				Slider.Name = "Slider"
				Slider:SetAttribute("ItemLabel", text)
			...
			function ChannelContent:Seperator()
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {Remove = function() Seperator1:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			function ChannelContent:Dropdown(text, list, callback)
				...
				Dropdown:SetAttribute("ItemLabel", text)
			...
			function ChannelContent:Colorpicker(text, preset, callback)
				...
				Colorpicker:SetAttribute("ItemLabel", text)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {Remove = function() Colorpicker:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			...
			function ChannelContent:Textbox(text, placetext, disapper, callback)
				...
				Textbox:SetAttribute("ItemLabel", text)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {Remove = function() Textbox:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			...
			function ChannelContent:Label(text)
				...
				Label.Name = "Label"
				Label:SetAttribute("ItemLabel", text)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {Remove = function() Label:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			...
			function ChannelContent:Bind(text, presetbind, callback)
				...
				Keybind:SetAttribute("ItemLabel", text)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {Remove = function() Keybind:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end}
			end
			
			-- ── NEW: Searchbox — filters all labelled items in this channel ──
			function ChannelContent:Searchbox(placeholder)
				local SearchFrame = Instance.new("Frame")
				local SearchOutline = Instance.new("Frame")
				local SearchOutlineCorner = Instance.new("UICorner")
				local SearchInner = Instance.new("Frame")
				local SearchInnerCorner = Instance.new("UICorner")
				local SearchIcon = Instance.new("TextLabel")
				local SearchBox = Instance.new("TextBox")

				SearchFrame.Name = "__searchbox__"
				SearchFrame.Parent = ChannelHolder
				SearchFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				SearchFrame.BackgroundTransparency = 1.000
				SearchFrame.Size = UDim2.new(0, 401, 0, 46)
				SearchFrame.LayoutOrder = -9999

				SearchOutline.Name = "SearchOutline"
				SearchOutline.Parent = SearchFrame
				SearchOutline.AnchorPoint = Vector2.new(0.5, 0.5)
				SearchOutline.BackgroundColor3 = Color3.fromRGB(37, 40, 43)
				SearchOutline.Position = UDim2.new(0.5, 0, 0.75, 0)
				SearchOutline.Size = UDim2.new(0, 399, 0, 32)

				SearchOutlineCorner.CornerRadius = UDim.new(0, 4)
				SearchOutlineCorner.Parent = SearchOutline

				SearchInner.Name = "SearchInner"
				SearchInner.Parent = SearchOutline
				SearchInner.AnchorPoint = Vector2.new(0.5, 0.5)
				SearchInner.BackgroundColor3 = Color3.fromRGB(48, 51, 57)
				SearchInner.ClipsDescendants = true
				SearchInner.Position = UDim2.new(0.5, 0, 0.5, 0)
				SearchInner.Size = UDim2.new(0, 397, 0, 30)

				SearchInnerCorner.CornerRadius = UDim.new(0, 4)
				SearchInnerCorner.Parent = SearchInner
				...
				SearchIcon.TextColor3 = Color3.fromRGB(114, 118, 125)
				...
				SearchBox.PlaceholderColor3 = Color3.fromRGB(91, 95, 101)
				SearchBox.Text = ""
				SearchBox.TextColor3 = Color3.fromRGB(193, 195, 197)
				SearchBox.TextSize = 14
				SearchBox.TextXAlignment = Enum.TextXAlignment.Left
				SearchBox.ClearTextOnFocus = false

				SearchBox.Focused:Connect(function()
					TweenService:Create(SearchOutline, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(114, 137, 228)}):Play()
				end)
				SearchBox.FocusLost:Connect(function()
					TweenService:Create(SearchOutline, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(37, 40, 43)}):Play()
				end)

				local function applyFilter()
					local q = SearchBox.Text:lower()
					for _, child in ipairs(ChannelHolder:GetChildren()) do
						-- Only filter items that have an ItemLabel attribute (skips layout, searchbox itself, separators)
						local lbl = child:GetAttribute("ItemLabel")
						if lbl ~= nil then
							if q == "" then
								child.Visible = true
							else
								child.Visible = (lbl:lower():find(q, 1, true) ~= nil)
							end
						end
					end
					ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return {
					Clear = function() SearchBox.Text = "" applyFilter() end,
					Remove = function() SearchFrame:Destroy(); ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) end
				}
			end
			-- ── end Searchbox ───────────────────────────────────────────────
